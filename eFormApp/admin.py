...
class ProduitModelAdmin(admin.ModelAdmin):
    list_display = ('categorie', 'name', 'content', 'price', 'digital', 'image', 'date_ajout')    
...
admin.site.site_title = "eForm Title"
admin.site.site_header = "eForm Header"
admin.site.index_title = "eForm Title"